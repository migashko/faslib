...
template<typename F, typename P0 = empty_type, typename P1 = empty_type, typename P2 = empty_type, typename P3 = empty_type, typename P4 = empty_type >
struct apply
{
  typedef typename type_list_n< w<P0>, w<P1>, w<P2>, w<P3>, w<P4> >::type arg_list;
...
struct apply2
{
  typedef typename bind<F, typename type_list_n< w<P0>, w<P1> >::type >::type binded_type;
  typedef typename detail::apply_helper<binded_type>::type type;
};
...
struct apply3
{
  typedef typename bind<F, typename type_list_n< w<P0>, w<P1>, w<P2> >::type >::type binded_type;
  typedef typename detail::apply_helper<binded_type>::type type;
};
...
struct apply4
{
  typedef typename bind<F, typename type_list_n< w<P0>, w<P1>, w<P2>, w<P3> >::type >::type binded_type;
  typedef typename detail::apply_helper<binded_type>::type type;
};
...
struct apply5
{
  typedef typename bind<F, typename type_list_n< w<P0>, w<P1>, w<P2>, w<P3>, w<P4> >::type >::type binded_type;
  typedef typename detail::apply_helper<binded_type>::type type;
};
