...
#include <fas/jsonrpc/ad_notify_handler.hpp>
#include <fas/jsonrpc/ad_request_handler.hpp>
#include <fas/jsonrpc/ad_process_notify.hpp>
#include <fas/jsonrpc/ad_process_request.hpp>
#include <fas/jsonrpc/ad_process_response.hpp>
...
typedef type_list_n<
  ...
  advice< _process_notify_, ad_process_notify >,
  advice< _process_request_, ad_process_request >,
  advice< _process_response_, ad_process_response >
