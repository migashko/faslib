...
struct index_of_if_impl;

template<typename M, typename L, typename F >
struct index_of_if_impl1;

template<typename L, typename F, bool B >
struct index_of_if_impl2;

#ifdef FASLIB_TYPE_LIST_CHECK

template<typename L, typename F>
struct index_of_if_verifying;

template<typename L, typename F>
struct index_of_if_helper
  : verifying< index_of_if_verifying<L, F>, check_list<L> >::type
{
};

template<typename L, typename F>
struct index_of_if_verifying
  : index_of_if_impl<L, F>
{
};
...
struct index_of_if_impl
{
  enum
  {
    first = index_of_if_impl1<typename L::metatype, L, F>::value,
...
struct index_of_if_impl< type_list<L, R>, F >
{
  enum
  {
    first = index_of_if_impl2< type_list<L, R>, F, apply1<F, L>::type::value >::value,
...
template<typename F >
struct index_of_if_impl< empty_list, F >
{
  enum { value = -1 };
};
...
template<typename L, typename F>
struct index_of_if_impl1<metalist::type_list, L, F>
{
  enum 
  {
    value = index_of_if_impl2< L, F, apply1<F, typename L::left_type>::type::value >::value 
  };
};

template<typename L, typename F>
struct index_of_if_impl1<metalist::empty_list, L, F>
{
  enum { value = 0 };
};

template<typename L, typename F>
struct index_of_if_impl2<L, F, true>
{
  enum { value = 0 };
};

template<typename L, typename F>
struct index_of_if_impl2<L, F, false>
{
  typedef typename L::right_type tail;
  enum { value = 1 + index_of_if_impl1<typename tail::metatype, tail, F>::value };
};

#ifndef DISABLE_TYPE_LIST_SPEC

template<typename L, typename LL, typename RR,  typename F>
struct index_of_if_impl2< type_list<L, type_list<LL, RR> >, F, false>
{
  enum { value = 1 + index_of_if_impl2< type_list<LL, RR>, F, apply1<F, LL>::type::value >::value };
};

template<typename L, typename F>
struct index_of_if_impl2< type_list<L, empty_list>, F, false>
{
  enum { value = 1 };
};

template<typename F>
struct index_of_if_impl2<empty_list, F, true>
{
  enum { value = 0 };
};
...
/*
template<typename F>
struct index_of_if_impl2< empty_list, F, false>
{
  enum { value = 1 };
};
*/
