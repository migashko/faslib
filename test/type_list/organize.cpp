...
int main()
{
  // list_6_1 l61;
  enum {
    test1 = static_check< some_type<organize<list_1>::type, check_1>::value >::value,
    test2 = static_check< some_type<organize<list_2>::type, list_2>::value >::value,
    test3 = static_check< some_type<organize<list_3>::type, check_3>::value >::value,
    test5 = static_check< some_type<organize<list_5>::type, check_5>::value >::value,
    test6 = static_check< some_type<organize<list_6>::type, check_6>::value >::value,
    test6_1 = static_check< some_type<organize<list_6_1>::type, check_6>::value >::value,
    test7 = static_check< some_type<organize<list_7>::type, check_7>::value >::value,
    test8 = static_check< some_type<organize<list_8>::type, check_8>::value >::value,
    test9 = static_check< some_type<organize<list_9>::type, check_9>::value >::value
