...
#define RET std::pair<typename T::iterator, bool>
FAS_HAS_MEMBER_FUNCTION1(has_insert, insert, RET, const typename T::value_type&)
*/
...
int main()
{
  ...
  op_mf3< std::vector<char>, char, &std::vector<char>::push_back> aa;*/
  enum {
