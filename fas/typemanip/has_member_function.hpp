...
{\
  typedef N##_detail::N##_helper helper; \
  enum { value = sizeof( helper::test<T, R>(fas_nullptr) ) == sizeof(helper::small_type) };\
};
...
{\
  typedef N##_detail::N##_helper helper; \
  enum { value = sizeof( helper::test<T, R, P1>(fas_nullptr) ) == sizeof(helper::small_type) };\
};
...
{\
  typedef N##_detail::N##_helper helper; \
  enum { value = sizeof( helper::test<T, R, P1, P2>(fas_nullptr) ) == sizeof(helper::small_type) };\
};
