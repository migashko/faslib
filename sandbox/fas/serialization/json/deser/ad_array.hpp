#ifndef FAS_SERIALIZATION_JSON_DESER_AD_ARRAY_HPP
#define FAS_SERIALIZATION_JSON_DESER_AD_ARRAY_HPP
...
struct ad_array
{
  ...
  {
    return t.get_aspect().template get<parse::_array_>().check(t, r)
