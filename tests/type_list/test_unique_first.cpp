...
typedef type_list_n<char, int, double, long>::type check_list1;
typedef type_list_n<char, int, long, double>::type check_list2;
typedef type_list_n<char, int>::type check_list3;

typedef unique_first<list_2>::type result_list1;
typedef unique_first<list_3>::type result_list2;
typedef unique_first<list_4>::type result_list3;
